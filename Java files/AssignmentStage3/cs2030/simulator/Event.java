...
public class Event implements Comparable<Event> {
    ...
    public Event(Customer cu, Server sv) {
        this.cu = cu;
        this.sv = sv;
    }
    ...
    public String toString() {
        ...
        switch (cu.getStatus()) {
            case SERVED:
                return out += " by server " + this.sv.getID();
            case WAITS:
                return out += " to be served by server " + this.sv.getID();
            case DONE:
                return out += " serving by server " + this.sv.getID();
            default:
                return out;
        }
    }
