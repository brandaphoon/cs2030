...
public class Customer implements Comparable<Customer> { 
    ...
    /**
     * The time taken the customer has to wait to be served.
     */
     ...
     * who are waiting.
     * @param id the id of the customer
     * @param time the time that customer arrives or the time that a event
     based on the status is executed
     * @param status the status of the customer
     * @param waitTime the time that the customer has to wait before being
     served
     */

    public Customer(int id, double time, Status status, double waitTime) {
        this.id = id;
        this.time = time;
        this.status = status;
    ...
    public Customer waiting(double time) {
        return new Customer(this.id, this.time, Status.WAITS, time);
    }
